export interface PromptDocument { readonly id:string; title:string; styles:string[]; bpm:number|null; key:string|null; instrumental:boolean; preamble:PromptLine[]; sections:PromptSection[]; sourcePath:string|null; sourceText:string|null; createdAt:string; updatedAt:string; }
