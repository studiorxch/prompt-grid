export interface PromptDocument { readonly id:string; title:string; styles:string[]; bpm:number|null; key:string|null; preamble:PromptLine[]; sections:PromptSection[]; sourcePath:string|null; sourceText:string|null; createdAt:string; updatedAt:string; }
...
export interface PromptGridSettings { inboxFolder:string; exportFolder:string; defaultTitlePrefix:string; characterWarningThreshold:number; preserveSourceText:boolean; }
